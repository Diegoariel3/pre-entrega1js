...
while (opcion > 3 || opcion < 1) {
  alert("Esa no es una opción válida, elija un número del 1 al 3");
  opcion = Number(prompt("1- 2X1    2- 2do al 50%    3- 2do al 80%"));
}
...
switch (opcion) {
  case 1:
    console.log('Ha elegido la opción 2x1');
    if (esPar()) {
  ...
  case 2:
    console.log('Ha elegido la opción 2do al 50%');
    if (esPar()) {
  ...
  case 3:
    console.log('Ha elegido la opción de 2do al 80%');
    if (esPar()) {
